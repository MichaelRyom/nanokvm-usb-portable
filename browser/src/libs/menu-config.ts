...
export const DEFAULT_MENU_CONFIG: MenuConfig = {
  visibleItems: ['video', 'audio', 'serialPort', 'keyboard', 'mouse', 'recorder', 'screenshot', 'settings', 'fullscreen'],
  hiddenItems: [],
  subMenus: {
...
export const MENU_ITEMS_META: MenuItemMeta[] = [
  ...
  { id: 'screenshot', labelKey: 'menu.screenshot', defaultLabel: 'Screenshot', requiresSerial: false, isProtected: false },
...
export const SUB_MENU_ITEMS_META: SubMenuItemMeta[] = [
  ...
  { id: 'keyboard.credentialVault', parent: 'keyboard', labelKey: 'keyboard.vault.title', defaultLabel: 'Credential Vault', isProtected: false, requiresSerial: true },
